...
public class Messages
{
    ...
    public static final String PREFIX = "§7[§5FTS-Engine§7] ",
                        ...
                        ALREADY_SETUP_BIRTH = PREFIX + "Du hast bereits deinen Geburtstag eingegeben!",
                        USAGE_NUMBER = PREFIX + "Bitte gebe natürliche Zahlen ein",
                        IS_NOT_ON = PREFIX+"Der Spieler muss Online sein!",
                        NOT_IN_WORLD = PREFIX + "Der Spieler %s muss in der selben Welt sein!",
                        NEED_TO_CLICK_ENTITY = PREFIX+"Okay, klick jetzt auf einen Spieler!",
                        NOW_IN_ROLEPLAY = PREFIX + "Du bist nun im Roleplay Modus!",
