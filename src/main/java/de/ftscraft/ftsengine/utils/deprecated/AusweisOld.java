...
public class AusweisOld {
    ...
    public AusweisOld(Engine plugin, UUID uuid, String firstName, String lastName, String spitzname, Gender gender, String race, String desc, int height, String link, double lastHeightChange) {
        this.plugin = plugin;
        this.uuid = uuid;
    ...
    public AusweisOld(Engine plugin, Player player) {
