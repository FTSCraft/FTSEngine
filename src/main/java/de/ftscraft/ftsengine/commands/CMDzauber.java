            ...
            if (player.hasPermission("zauber.zauber")) {
                if (command.getName().equalsIgnoreCase("zauber")) {
                    if (player instanceof Player) {
                        if (args.length == 0) {
                            player.sendMessage("§7[§5FTS-Engine§7] Bitte benutze den Command so:                        §c/zauber §8[§cZaubername§8]§7 oder §c/zauber liste§7.");
                            ...
                            if (args[0].equalsIgnoreCase("liste")) {
                                ...
                                player.sendMessage("§7[§5FTS-Engine§7] §bhttps://forum.ftscraft.de/t/tutorial-so-funktioniert-magie-auf-unserem-server/8363");
